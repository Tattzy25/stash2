...
export function ImageDisplay({
  ...
  return (
    <>
      ...
      >
        {(image || failed) && (
          <div className="absolute top-2 left-2 flex max-w-[75%] items-center gap-2 rounded-lg bg-white/95 px-2 py-1">
            <TooltipProvider>
              <Tooltip delayDuration={100}>
                <TooltipTrigger asChild>
                  <Label className="min-w-0 grow truncate text-gray-900 text-xs">
        ...
        {image && !failed ? (
          <>
            ...
            {timing?.elapsed && (
              <div className="absolute right-2 bottom-2 rounded-md bg-black/70 px-2 py-1 shadow backdrop-blur-sm">
